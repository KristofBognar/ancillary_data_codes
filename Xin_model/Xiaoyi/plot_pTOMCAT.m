...
for i = 1:1:N(1)
    ...
    [tmp_lat,tmp_lon, tmp_vcd]=plot_VCD_single_time_step(i,species ,file_nm,time_stamp,VCD_type);
...
%% 
function [lat_out,lon_out, vcd]=plot_VCD_single_time_step(time_step,species,file_nm,time_stamp,VCD_type)
