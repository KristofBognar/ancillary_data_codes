% plot surface ozone data from Eureka
% run from \home\kristof\work\surface_ozone
...
if download_files
    ...
    for i=1:length(f_list)
        ...
        % read given file
        [t_tmp,o3_tmp]=read_surf_o3(f_list{i});
...
if merge_files
    ...
    surf_o3=table();
    surf_o3.DateTime=time;
    surf_o3.year=year;
    surf_o3.ft=o3_ft_all;
    surf_o3.o3_ppb=o3_ppb_all;
    
    save surf_o3_all.mat surf_o3
